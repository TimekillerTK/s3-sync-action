# GitHub Action to Sync S3 Bucket with CloudFront Cache Invalidation 🔄

This simple action uses the [vanilla AWS CLI](https://docs.aws.amazon.com/cli/index.html) to sync a directory (either from your repository or generated during your workflow) with a remote S3 bucket. Also creates CloudFront cache invalidation. 
...
| `DISTRIBUTION_ID` | Your AWS Cloudfront Distribution ID. | `secret env` | **Yes** | N/A |
